...
class CompaniesSearch extends Companies
{
    ...
    public function rules()
    {
        return [
            [['company_id'], 'integer'],
            [['company_name', 'globalSearch','company_email', 'company_adress', 'company_created_date', 'company_status'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
      ...
      /*  $query->andFilterWhere([
        ...
        $query->andFilterWhere(['like', 'company_name', $this->globalSearch])
            ->orFilterWhere(['like', 'company_email', $this->globalSearch])
            ->orFilterWhere(['like', 'company_adress', $this->globalSearch])
